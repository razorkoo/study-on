 ...
 */
final class Version20190412061745 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE lesson (id INT NOT NULL, lesson_course_id INT NOT NULL, title_lesson VARCHAR(255) NOT NULL, content_lesson TEXT NOT NULL, serial_number INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_F87474F33D3F2618 ON lesson (lesson_course_id)');
        $this->addSql('CREATE TABLE course (id INT NOT NULL, title_course VARCHAR(255) NOT NULL, description_course VARCHAR(1000) NOT NULL, PRIMARY KEY(id))');
